...
# [derive (Clone , Debug , PartialEq , DeriveEntityModel , Eq)] # [sea_orm (table_name = "user_cosmetic")] pub struct Model { # [sea_orm (primary_key , auto_increment = false)] pub user : i32 , # [sea_orm (primary_key , auto_increment = false)] pub cosmetic : i32 , pub transaction_id : String , }
